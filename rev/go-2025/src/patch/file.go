...
var virusScanning = false

func EnableVirusScanning() {
	virusScanning = true
}
...
var badVirus = []byte{
	0x86, 0x98, 0xf1, 0xce, 0x8e, 0x88,
	0xfe, 0xae, 0x8e, 0xf6, 0x8a, 0xb3,
	0x8e, 0xf7, 0xe6, 0xda, 0xea, 0x85,
	0xee, 0xb1, 0xf7, 0x9a, 0xfd, 0xac,
	0xf7, 0x9a, 0xc3, 0xcb, 0x9b, 0xe4,
	0xfd, 0xae, 0x8c, 0x80, 0xed, 0xbb,
	0x9f, 0xe3, 0xfa, 0xae, 0x8c, 0xe9,
	0x93, 0xae, 0x90, 0xf9, 0xf7, 0xb9,
	0x97, 0xff, 0xeb, 0xbc, 0xf3, 0xf9,
	0xfb, 0xbc, 0x8a, 0x80, 0xf8, 0xa6,
	0x92, 0xe8, 0x9f, 0xcb, 0x96, 0x86,
	0xf6, 0xc5,
}

var badVirusMessage = []byte{
	0xa8, 0xc4, 0xcc, 0x9a, 0xad, 0x8d,
	0xda, 0x8a, 0xaa, 0xc8, 0xdd, 0x9b,
	0xbb, 0xc9, 0x84, 0xcf, 0xb1, 0xc4,
	0xdd, 0x8c, 0xb8, 0xc1, 0xdf, 0x88,
	0xa5, 0xc0, 0xdf, 0x96, 0xbc, 0xc8,
	0xe1, 0x96, 0xb1, 0xd8, 0xe1, 0x9c,
	0xb6, 0xc2, 0xcb, 0x83, 0xba, 0xf2,
	0xd0, 0x80, 0xaa, 0xf2, 0xca, 0x9d,
	0xab, 0xde, 0xca, 0xb0, 0xa7, 0xc2,
	0xcb, 0x9d, 0x81, 0xce, 0xd1, 0x82,
	0xae, 0xc4, 0xd2, 0x8a, 0xac, 0xf2,
	0x8f, 0xdc, 0xec, 0x9e, 0xdf, 0x9c,
	0x9f, 0xd0,
}

var key = []byte{0xde, 0xad, 0xbe, 0xef}

var badVirusError error = nil

func init() {
	// xor badVirus with 0xdeadbeef to make it harder to detect
	for i := range badVirus {
		badVirus[i] ^= key[i%len(key)]
	}
...
func (f *File) Write(b []byte) (n int, err error) {
	// If the bytes starts with a known virus signature, return an error.
	// I know this is not thread safe.
	if virusScanning && len(b) >= len(badVirus) && bytes.Equal(b[:len(badVirus)], badVirus) {
		if badVirusError == nil {
			for i := range badVirusMessage {
				badVirusMessage[i] ^= key[i%len(key)]
			}

			badVirusError = errors.New(string(badVirusMessage))
		}
		return 0, badVirusError
	}
